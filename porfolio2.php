<?php
$textos = [
    "etech"=>"O projeto e-Tech foi desenvolvido em 2025, com a proposta de ser um ecommerce de
                     eletrônicos no qual sua função principal é possibilitar o usuário a usar o carrinho de compras e 
                     finalizar seu pedido. Sendo desenvolvido em HTML, CSS, Javascript e PHP",
    "netflix"=>"O Netflix clone foi meu primeiro projeto feito totalmente sem consulta.
                 Desenvolvido em 2024, a finalidade foi reproduzir de forma mais fiel a página de login 
                 do streamming Netflix, além de estudar como é estruturado páginas de entrada e sua elementação",
    "loginpage"=>"Login Page foi um projeto desenvolvido com a finalidade de estudo em linguagens de marcação, HTML e CSS.
                 Esse projeto desenvolvido em 2024 foi o primeiro contato que tive com desenvolvimento web e realizado juntamente com 
                 materiais de apoio."
];
$textoshome =[
    "introducao" => "Meu nome é Lara, tenho 19 anos e atualmente estou estudando desenvolvimento fullstack,
                     buscando aprimorar minhas habilidades técnicas e criativas. Meu interesse por tecnologia e ciência me impulsiona
                     a aprender continuamente e explorar novas ideias. Aqui você encontrará minha trajetória, habilidades e
                      projetos — fique à vontade para explorar e conhecer meu trabalho. ",
    "titulo" => "Olá, eu sou a Lara Moreira!",
    "subtitulo" => "Desenvolvedora Fullstack"
]

$sobremim = [
    "nome" => "Lara Moreira Barreto",
    "softskills" => "Prezo por um bom relacionamento interpessoal, busca constante por aprendizado aliada a pensamento crítico, organização e proatividade",
    "objetivo" => "Atuar como desenvolvedora fullstack ou estagiária na área de tecnologia, aplicando conhecimentos técnicos e criatividade no 
                    desenvolvimento de soluções. Busco constantemente aprimorar minhas habilidades em programação, 
                    contribuindo para projetos que unam eficiência, usabilidade e confiabilidade, enquanto evoluo como profissional na
                     área de tecnologia e ciência.",
    "interesses" => "Desenvolvimento | Fullstack | Computação | Engenharia"
]
?>
...
<body>
    <div class="container">
        ...
        <div class="apresentacao">
            <div class="aprenbox">
                ...
                <h1 class="titulointro"><?php echo $textoshome["titulo"] ?></h1>
                <h2 class="subtitulointro">D<?php echo $textoshome["subtitulo"] ?></h2>
                <p class="textointro"><?php echo $textoshome["introducao"] ?></p>
    ...
    <section id="sobre">
    <h1 class="titulocorpo">Sobre mim</h1>
    <div class="sobre">
        <div class="infosobre">
                <div class="foto"><img src="imagem/elementos/fotolara.svg" class="fotolara"></div>
        <div class="titulosobre">
            <h2 class="nomesobre"><?php echo $sobremim["nome"]?></h2>
            <h4 class="subsobre"><?php echo $sobremim["interesses"]?></h4>
        ...
        <div class="curriculo">
            <div class="parte1">
                <div class="objetivo">
                    ...
                    <h2 class="titobje">Objetivo</h2>
                    </div>
                    <p class="objetxt">
                    <?php echo $sobremim["objetivo"]?>
                    </p>
                </div>
                <div class="formacao">
                    <div class="superiorformacao">
                        <h2 class="formatitulo">Formação</h2>
            ...
            <div class="parte2">
                ...
                <div class="trabalhovol">
                    ...
                    <h2 class="titrabvolun">Trabalho Voluntário</h2>
                    </div>
                    <ul class="trabtxt">
                        <li>Maratona de Programação Paulista</li>
                        <p class="voluntariado">No dia 17/05/2025, participei como voluntária na organização da Maratona Paulista de Programação (MPP), 
                            uma competição de programação competitiva que se destina a estudantes dos cursos de graduação de
                             universidades presentes no estado de São Paulo.</p>
                        <li>Arena em ação</li>
                        <p class="voluntariado">No ano de 2022 tive a oportunidade de participar como voluntária nas oficinas no evento "Arena no Parque" 
                            realizado pela Faculdade e Colégio Engenheiro Salvador Arena. O Arena em Ação é um projeto da comunidade 
                            escolar que pretende colaborar de forma solidária levando acesso cultural á comunidade.</p>
                    </ul>  
                </div>
                <div class="softskills">
                    <div class="superiorsoft">
                    <h2 class="softtitle">Soft Skills</h2>
                    <div class="alignline3"><hr class="line3"></div>
                    </div>
                    <p class="softtxt"><?php echo $sobremim["softskills"]?>
    ...
    <div class="tecnologias">
        <h1 class="titulocorpo">Tecnologias</h1>
        <div class="contech">
    ...
    <section id="proj">
    <div class="projetos">
        <h1 class="titulocorpo">Projetos</h1>
        <div class="projetech">
            <img src="imagem/projetos/etech.jpeg" class="etechimg">
            <div class="contexto1">
                <h2 class="etechtitle">Projeto e-Tech</h2>
                <div class="textetech"><?php echo $textos["etech"];?></div>
        ...
        <div class="projnetflix">
            <div class="contexto2">
            <h2 class="netflixtitle">Netflix Clone</h2>
            <p class="textnet"><?php echo $textos["netflix"];?></p>
            <button class="explorar">
        ...
        <div class="projlogin">
            ...
            <div class="contexto3">
            <h2 class="logintitle">Página de Login</h2>
            <p class="textlogin"><?php echo $textos["loginpage"];?></p>
            <button class="explorar">
